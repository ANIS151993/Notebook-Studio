...
and provides no deterministic cleaning guarantee. Neptyne~\cite{neptyne2023}
extends spreadsheet metaphors with Python formulas, targeting tabular
manipulation rather than notebook automation. Hex~\cite{hex2023} is a
...
DataMentor differs from all four: preprocessing is deterministic and
